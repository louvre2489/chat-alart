...
var author$project$Main$GetRooms = function (a) {
	return {$: 'GetRooms', a: a};
};
...
var author$project$Main$getRooms = elm$http$Http$request(
	{
		body: elm$http$Http$emptyBody,
		expect: A2(elm$http$Http$expectJson, author$project$Main$GetRooms, author$project$Main$roomsDecoder),
...
var author$project$Main$reverseCheck = F3(
	function (roomId, checkedRoomId, isChecked) {
		return _Utils_eq(roomId, checkedRoomId) ? (!isChecked) : isChecked;
	});
			...
			case 'GetRooms':
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						author$project$Main$Data(rooms),
...
var author$project$Main$checkbox = function (room) {
	return A2(
		elm$html$Html$input,
		_List_fromArray(
			[
				elm$html$Html$Attributes$type_('checkbox'),
				elm$html$Html$Attributes$class('switch__input'),
				elm$html$Html$Attributes$checked(room.isChecked),
				elm$html$Html$Events$onClick(
				author$project$Main$Checked(room))
			]),
		_List_Nil);
};
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$class('column is-1 toggle_width')
												]),
											_List_fromArray(
												[
													A2(
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	elm$html$Html$Attributes$class('switch__label')
																]),
															_List_fromArray(
																[
																	author$project$Main$checkbox(room),
																	A2(
																	elm$html$Html$span,
																	_List_fromArray(
																		[
																			elm$html$Html$Attributes$class('switch__content')
																		]),
																	_List_Nil),
																	A2(
																	elm$html$Html$span,
																	_List_fromArray(
																		[
																			elm$html$Html$Attributes$class('switch__circle')
																		]),
																	_List_Nil)
																]))
														]))
...
var author$project$Main$viewRooms = function (model) {
	switch (model.$) {
		case 'Failure':
			return A2(
				elm$html$Html$div,
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						author$project$Main$renderList(rooms)
					]));
	}
};
